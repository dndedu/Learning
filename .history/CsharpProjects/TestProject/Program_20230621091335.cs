...
do
{
    //Original case-sensitive input not saved
    // userInput = Console.ReadLine().Trim().ToLower();

    //approach to save original input
    // userInput = Console.ReadLine();
    // userInput_modified = userInput.Trim().ToLower();

    //second approach to save original input; copy String, modify copy, check if same String is effected (2 pointer at one String, Stringpool)
    userInput = Console.ReadLine();
    // userInput_modified = userInput;
    userInput_modified = userInput_modified.Trim().ToLower();
