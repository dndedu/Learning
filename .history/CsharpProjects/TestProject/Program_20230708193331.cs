...
contentEnd = input.IndexOf(secondSearchTerm, contentStart);
output.Remove(contentStart, firstSearchTerm.Length);
output.Remove(contentEnd, secondSearchTerm.Length);
